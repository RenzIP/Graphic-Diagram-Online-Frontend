...
function getEdgeGeometry(sourceNode, targetNode, edge = {}, bundle = { index: 0, total: 1 }, allNodes = []) {
	...
	// a comfortable buffer so the entire marker stays outside the shape, even
	// when the edge is selected and its stroke width grows by 1px.
	const strokeWidth = edge.style?.strokeWidth || 2;
	const markerPad = 5 * strokeWidth + 8;
