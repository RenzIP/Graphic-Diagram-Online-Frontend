const DIAGRAM_TEMPLATES = {
  flowchart: {
    ...
    edges: [
      ...
      { id: "e3", source: "3", target: "4", label: "No", type: "step", sourceHandle: "right", targetHandle: "left", markerEnd: "arrow" },
      { id: "e4", source: "3", target: "5", label: "Yes", type: "default", sourceHandle: "bottom", targetHandle: "top", markerEnd: "arrow" },
      { id: "e5", source: "5", target: "6", type: "default", sourceHandle: "bottom", targetHandle: "top", markerEnd: "arrow" },
      { id: "e6", source: "6", target: "7", type: "default", sourceHandle: "bottom", targetHandle: "top", markerEnd: "arrow" }
    ]
  },
  erd: {
    nodes: [
  ...
  usecase: {
    nodes: [
      ...
      // Actors
      { id: "a1", type: "actor", position: { x: 100, y: 180 }, width: 80, height: 120, label: "Customer", color: "indigo" },
      { id: "a2", type: "actor", position: { x: 100, y: 380 }, width: 80, height: 120, label: "Admin", color: "red" },
      // Use Cases
      {
        id: "uc1",
        type: "usecase",
    ...
    edges: [
      { id: "e1", source: "a1", target: "uc1", type: "default", sourceHandle: "right", targetHandle: "left", markerEnd: "arrow" },
      { id: "e2", source: "a1", target: "uc2", type: "default", sourceHandle: "right", targetHandle: "left", markerEnd: "arrow" },
      { id: "e3", source: "a1", target: "uc3", type: "default", sourceHandle: "right", targetHandle: "left", markerEnd: "arrow" },
      { id: "e4", source: "a2", target: "uc1", type: "default", sourceHandle: "right", targetHandle: "left", markerEnd: "arrow" },
      { id: "e5", source: "a2", target: "uc4", type: "default", sourceHandle: "right", targetHandle: "left", markerEnd: "arrow" }
    ]
  },
  sequence: {
    nodes: [
